...
from benchmark_spec import get_demand_flows, get_edges, get_internal_node_ids
...
def compute_crrank() -> dict[str, object]:
    ...
    return {
        ...
        "notes": [
            "Generated for the 20-intersection benchmark using the standalone CRRank refresh script.",
            "This output is kept separate from any manually edited control_roles file.",
        ],
    }
