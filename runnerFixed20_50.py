...
DEFAULT_OUTPUT_DIR = ROOT / "runnerFixed20_outputs_fixed50"
DEFAULT_FIXED_GREEN_DURATION = 50
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run the 20-node benchmark under 50-second fixed-time control using runnerFixed travel-time measurement."
    )
    parser.add_argument(
        "--scenario-dir",
    ...
    parser.add_argument("--episodes", type=int, default=DEFAULT_EPISODES, help="Number of fixed-time episodes to run.")
...
def main() -> None:
    ...
    for episode_index in range(1, args.episodes + 1):
        ...
        print(
            f"runnerFixed20_50 ep {episode_index:>3}/{args.episodes} | "
    ...
    print("runnerFixed20_50 complete.")
